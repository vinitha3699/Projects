...
# Data Zone
    ...
    with tab1:
        ...
        if Get_data or st.session_state.Get_state:
            ...
            api_key="AIzaSyDsHKYEs_UBu9RP5Zb-uBaZy8Twxt8nkhk"           
    ...
    #[Function to get channel statisics]
            ...
            try:
                ...
                get_channel_stats("UCPr2A4dx8qfMcKDE0coBl8A")
...
#**GET COMMENT INFORMATION**
            ...
            with tab2:
                ...
                if Migrate or st.session_state_migrate_sql:
                    ...
                    engine = create_engine("mysql+pymysql://root:@localhost:3306/youtubedata")
...
if selected == "Analysis Zone":
    ...
    if Check_channel:
        ...
        connect_for_question = pymysql.connect(host='localhost', user='root', password='', port=3306, db='youtubedata')
