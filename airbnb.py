...
if SELECT == "Explore Data":
 ...
 if fl is not None:
    ...
    os.chdir(r"C:\Users\hp\Desktop\Airbnb\Airbnb NYC 2019.csv")
...
if SELECT == "Contact":
    Name = (f'{"Name :"}  {"Vinitha V"}')
    mail = (f'{"Mail :"}  {"v920150@gmail.com"}')
    description = "An Aspiring DATA-SCIENTIST..!"
    #social_media = {
       # "GITHUB": "https://github.com/vinitha3699",
       # "LINKEDIN": "https://www.linkedin.com/in/vinitha-velu-bb28b2222/"}

col1, col2 = st.columns(2)

 # Load and display the image
with col1:
        image = Image.open(r"C:\Users\hp\Desktop\Airbnb\IMG_20240521_104253.jpg")
