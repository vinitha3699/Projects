...
engine = create_engine("mysql+pymysql://root:Erakart143$@localhost:3306/phonepe_pulse_data")
connection = engine.connect()

conn = pymysql.connect(host='localhost', user='root', password='Erakart143$', database='phonepe_pulse_data')
cursor = conn.cursor()


#insurance trans

path1=("C:/Users/Admin/Desktop/Cap Stone Project/phonepe/pulse/data/aggregated/insurance/country/india/state/")
...
#agg_trans
path2=("C:/Users/Admin/Desktop/Cap Stone Project/phonepe/pulse/data/aggregated/transaction/country/india/state/")
...
#aggregate_user
path3=("C:/Users/Admin/Desktop/Cap Stone Project/phonepe/pulse/data/aggregated/user/country/india/state/")
...
path4=("C:/Users/Admin/Desktop/Cap Stone Project/phonepe/pulse/data/map/insurance/hover/country/india/state/")
...
#maptransaction
path5=("C:/Users/Admin/Desktop/Cap Stone Project/phonepe/pulse/data/map/transaction/hover/country/india/state/")
...
#mapuser
path6=("C:/Users/Admin/Desktop/Cap Stone Project/phonepe/pulse/data/map/user/hover/country/india/state/")
...
#topinsurance
path7=("C:/Users/Admin/Desktop/Cap Stone Project/phonepe/pulse/data/top/insurance/country/india/state/")
...
#toptransaction
path8=("C:/Users/Admin/Desktop/Cap Stone Project/phonepe/pulse/data/top/transaction/country/india/state/")
...
#topuser
path9=("C:/Users/Admin/Desktop/Cap Stone Project/phonepe/pulse/data/top/user/country/india/state/")
...
if selected == "About":
    ...
    col1.image(Image.open("C:/Users/Admin/Pictures/Screenshots/phonpe2.jpg"), width=500)
    with col1:
        st.subheader(
    ...
    with col2:
        st.video("C:/Users/Admin/Documents/Downloads/pulse-video.mp4")
...
if selected == "Home":
    col1,col2 = st.columns(2)
    with col1:
        st.image(Image.open("C:/Users/Admin/Pictures/Screenshots/PHONEPE_files/pulseimage.jpg"), width=700)
    with col2:
        ...
        st.markdown("## :violet[Done by] : REVATHI KARTHIKEYAN")
        st.markdown("[Inspired from](https://www.phonepe.com/pulse/)")
        st.markdown("[Githublink](https://github.com/Revakarthi/)")
        st.markdown("[LinkedIn](https://www.linkedin.com/in/revathi-karthikeyan-999951215/)")
    st.write("---")
